...
export const Physics = {
    update(car, dt) {
        ...
        const gearMaxSpeed = (car.gearMaxSpeeds[gearIndex] || car.topSpeed) / 20;
        const maxCarSpeed = car.topSpeed / 20;
        ...
        const previousGearMaxSpeed = gearIndex === 0
            ? 0
            : Math.min((car.gearMaxSpeeds[gearIndex - 1] || 0) / 20, maxCarSpeed);
        ...
        const powerToWeight = car.hp / car.weight;
        const torqueToWeight = car.torque / car.weight;
        ...
        // ===== TRACTION =====
        const torqueLoad = car.torque / car.weight;
        const launchGrip = car.grip * 4.5;
        const speedGrip = car.spd * 0.35;
        const gripLimit = launchGrip + speedGrip;
        const torqueSpinPressure = torqueLoad * 65;
        const adjustedGripLimit = gripLimit - torqueSpinPressure;
        if (accel > gripLimit) {
            car.wheelspin = true;
        ...
        // ===== DRAG =====
        const drag = car.spd * car.spd * 0.02;
