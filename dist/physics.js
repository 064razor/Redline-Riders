...
export const Physics = {
    update(car, dt) {
        ...
        const accelRatio = 1 + ((driveRatio - 1) * 0.30);
        ...
        // ===== TARGET RPM =====
        const targetRPM = car.spd * driveRatio * 330;
        // ===== RPM SMOOTHING =====
        ...
        // ===== GEAR SPEED LIMIT =====
        const gearMax = car.gearMaxSpeeds[car.gear - 1] / 20;
        const allowedTopSpeed = Math.min(gearMax, car.topSpeed);
