...
function drawCarBody(ctx, car, x, y, facing) {
    ...
    Bodywork.drawRim(ctx, rimStyle, sprite.rearWheel.x, sprite.rearWheel.y, wheelSpin, speedBlur);
    Bodywork.drawRim(ctx, rimStyle, sprite.frontWheel.x, sprite.frontWheel.y, wheelSpin + 0.35, speedBlur);
    ctx.restore();
}
